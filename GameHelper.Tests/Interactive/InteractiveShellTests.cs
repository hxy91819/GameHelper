...
namespace GameHelper.Tests.Interactive
{
    ...
    public class InteractiveShellTests
    {
        ...
        public async Task RunAsync_LaunchMonitor_ShowsSessionSummary()
        {
            ...
            Assert.Contains($"近 {StatisticsService.PreviewWindowDays} 天暂无游玩记录", snapshot); // 窗口外的 2024 历史不参与预览
        ...
        public async Task RunAsync_LaunchMonitor_ShowsAggregatedHistoryPreview()
        {
            ...
            Assert.Contains($"近 {StatisticsService.PreviewWindowDays} 天 · 2 次会话 · 1 款游戏", snapshot);
